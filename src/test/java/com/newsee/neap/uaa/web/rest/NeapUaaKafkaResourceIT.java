...
public class NeapUaaKafkaResourceIT {
    ...
    @Autowired
    private NeapUaaKafkaProducer producer;

    @Autowired
    private NeapUaaKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        NeapUaaKafkaResource kafkaResource = new NeapUaaKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/neap-uaa-kafka/publish?message=test"))
